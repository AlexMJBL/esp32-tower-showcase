          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/80">
                ...
                <span className="text-[10px] text-slate-500">Air ambiant</span>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/80">
                ...
                <span className="text-[10px] text-slate-500">Humidité relative</span>
              </div>
            </div>
            ...
            <div className="p-3 rounded-2xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="text-xs text-slate-300 font-medium block">Pression Atmosphérique</span>
                  <span className="text-[10px] text-slate-500">Baromètre local</span>
                </div>
              </div>
